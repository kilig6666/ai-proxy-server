      ...
      <div style={{ width: "100%", maxWidth: 380, padding: "0 24px" }}>
        ...
        <div style={{ marginTop: 16, display: "flex", justifyContent: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 999, border: `1px solid ${C.purple}`, background: C.bgCard, color: C.textMuted, fontSize: 12, fontWeight: 600, boxShadow: `0 8px 24px ${C.shadow}` }}>
            <span style={{ color: C.gradientB, fontFamily: "monospace", fontWeight: 700, letterSpacing: "0.06em" }}>v3.0</span>
    ...
    return (
      <div>
        <div style={{ position: "absolute", top: 16, right: 16, display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: C.gradientB, background: C.purpleDark, border: `1px solid ${C.purple}`, borderRadius: 6, padding: "2px 7px", letterSpacing: "0.06em", fontFamily: "monospace" }}>v3.0</div>
